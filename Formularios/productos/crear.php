                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="preciopaquete" name="preciopaquete" placeholder="precio paquete" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="noexistencias" id="noexistencias" placeholder="existencias" required>
                            </div>
                            <div class="mb-3">
