                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['descripcioncategoria'] ?></th>
                            <th scope="row"><?php echo $resultado['fechacreacion'] ?></th>
                            <th scope="row"><?php echo $resultado['creadorcategoria'] ?></th>
                            <th scope="row"><?php echo $resultado['notacategoria'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/categorias/actualizar.php?idcategoria=<?php echo $resultado['idcategoria'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDC/eliminarDatos.php?idcategoria=<?php echo $resultado['idcategoria'] ?>" class="btn btn-outline-danger">
