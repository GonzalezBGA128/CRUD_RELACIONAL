                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['establecimiento'] ?></th>
                            <th scope="row"><?php echo $resultado['correo'] ?></th>
                            <th scope="row"><?php echo $resultado['telefono'] ?></th>
                            <th scope="row"><?php echo $resultado['direccionempresa'] ?></th>
                            <th scope="row"><?php echo $resultado['nombreempresa'] ?></th>
                            <th scope="row"><?php echo $resultado['codigopostal'] ?></th>
                            <th scope="row"><?php echo $resultado['pais'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/marcas/actualizar.php?idprovedoor=<?php echo $resultado['idprovedoor'] ?>" class="btn btn-outline-warning">
                                    <i class="fa-solid fa-pen-to-square fa-beat"></i>
                                </a>
                                <a href="<?php echo base_url; ?>CRUDM/eliminarDatos.php?idprovedoor=<?php echo $resultado['idprovedoor'] ?>" class="btn btn-outline-danger">
