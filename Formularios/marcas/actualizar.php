    ...
    <div class="container mt-5 mb-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center">ACTUALIZAR PROVEDOOR</h5>
                        <form action="<?php echo base_url; ?>CRUDM/editarDatos.php" method="post">
                            <?php
                            include_once("../../config/conexion.php");

                            $sql = "SELECT * FROM provedoor WHERE idprovedoor =" . $_REQUEST['idprovedoor'];
                            $resultado = $conexion->query($sql);

                            $row = $resultado->fetch_assoc();
                            ?>
                            <input type="hidden" class="form-control" name="idprovedoor" id="idprovedoor" value="<?php echo $row['idprovedoor'] ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="direccionempresa" name="direccionempresa" placeholder="direccion empresa" value="<?php echo $row['direccionempresa'] ?>">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="codigopostal" name="codigopostal" placeholder="codigo postal" value="<?php echo $row['codigopostal'] ?>">
                            </div>
                            <div class="mb-3">
